...
To expose this functionality, the contract must implement the [SRC5Component](/contracts-cairo/2.x/api/introspection#SRC5Component), which defines the `supports_interface` function.
