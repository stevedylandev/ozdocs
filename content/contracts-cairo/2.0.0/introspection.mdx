...
To expose this functionality, the contract must implement the [SRC5Component](api/introspection#SRC5Component), which defines the `supports_interface` function.
