...
The `path` argument should be the imported component itself (in this case, [InitializableComponent](/contracts-cairo/2.0.0/security#initializable)).
...
Components also separate granular implementations from [mixin](/contracts-cairo/2.0.0/components#mixins) implementations.
