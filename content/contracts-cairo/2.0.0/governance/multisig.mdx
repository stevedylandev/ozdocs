...
Integrating the Multisig functionality into a contract requires implementing [MultisigComponent](/contracts-cairo/api/governance#MultisigComponent).
...
This is the interface of a contract implementing the [MultisigComponent](/contracts-cairo/api/governance#MultisigComponent):
