...
<APIItem
    functionName="has_role(role: felt252, account: ContractAddress) → bool"
...
<APIItem
    functionName="get_role_admin(role: felt252) → felt252"
...
<APIItem
    functionName="grant_role(role: felt252, account: ContractAddress)"
...
<APIItem
    functionName="revoke_role(role: felt252, account: ContractAddress)"
...
<APIItem
    functionName="renounce_role(role: felt252, account: ContractAddress)"
...
<APIItem
    functionName="RoleAdminChanged(role: felt252, previous_admin_role: ContractAddress, new_admin_role: ContractAddress)"
...
<APIItem
    functionName="RoleGranted(role: felt252, account: ContractAddress, sender: ContractAddress)"
...
<APIItem
    functionName="RoleRevoked(role: felt252, account: ContractAddress, sender: ContractAddress)"
...
<APIItem
    functionName="get_role_status(role: felt252, account: ContractAddress) → RoleStatus"
...
<APIItem
    functionName="grant_role_with_delay(role: felt252, account: ContractAddress, delay: u64)"
...
<APIItem
    functionName="RoleGrantedWithDelay(role: felt252, account: ContractAddress, sender: ContractAddress, delay: u64)"
...
<APIItem
    functionName="default_admin() → ContractAddress"
...
<APIItem
    functionName="pending_default_admin() → (ContractAddress, u64)"
...
<APIItem
    functionName="default_admin_delay() → u64"
...
<APIItem
    functionName="pending_default_admin_delay() → (u64, u64)"
...
<APIItem
    functionName="begin_default_admin_transfer(new_admin: ContractAddress)"
...
<APIItem
    functionName="cancel_default_admin_transfer()"
...
<APIItem
    functionName="accept_default_admin_transfer()"
...
<APIItem
    functionName="change_default_admin_delay(new_delay: u64)"
...
<APIItem
    functionName="rollback_default_admin_delay()"
...
<APIItem
    functionName="default_admin_delay_increase_wait() → u64"
...
<APIItem
    functionName="DefaultAdminTransferScheduled(new_admin: ContractAddress, accept_schedule: u64)"
...
<APIItem
    functionName="DefaultAdminTransferCanceled()"
...
<APIItem
    functionName="DefaultAdminDelayChangeScheduled(new_delay: u64, effect_schedule: u64)"
...
<APIItem
    functionName="owner(self: @ContractState) → ContractAddress"
...
<APIItem
    functionName="transfer_ownership(ref self: ContractState, new_owner: ContractAddress)"
...
<APIItem
    functionName="renounce_ownership(ref self: ContractState)"
...
<APIItem
    functionName="pending_owner(self: @ContractState) → ContractAddress"
...
<APIItem
    functionName="accept_ownership(ref self: ContractState)"
...
<APIItem
    functionName="transferOwnership(ref self: ContractState, newOwner: ContractAddress)"
...
<APIItem
    functionName="renounceOwnership(ref self: ContractState)"
...
<APIItem
    functionName="pendingOwner(self: @ContractState)"
...
<APIItem
    functionName="acceptOwnership(self: @ContractState)"
...
<APIItem
    functionName="transferOwnership(self: @ContractState)"
    id="OwnableComponent-two-step-transferOwnership"
    kind="external"
>
...
<APIItem
    functionName="renounceOwnership(self: @ContractState)"
    id="OwnableComponent-two-step-renounceOwnership"
    kind="external"
>
...
<APIItem
    functionName="initializer(ref self: ContractState, owner: ContractAddress)"
...
<APIItem
    functionName="assert_only_owner(self: @ContractState)"
...
<APIItem
    functionName="_transfer_ownership(ref self: ContractState, new_owner: ContractAddress)"
...
<APIItem
    functionName="_propose_owner(ref self: ContractState, new_owner: ContractAddress)"
...
<APIItem
    functionName="OwnershipTransferStarted(previous_owner: ContractAddress, new_owner: ContractAddress)"
...
<APIItem
    functionName="OwnershipTransferred(previous_owner: ContractAddress, new_owner: ContractAddress)"
...
<APIItem
    functionName="has_role(self: @ContractState, role: felt252, account: ContractAddress) → bool"
...
<APIItem
    functionName="get_role_admin(self: @ContractState, role: felt252) → felt252"
...
<APIItem
    functionName="get_role_status(self: @ContractState, role: felt252, account: ContractAddress) → RoleStatus"
...
<APIItem
    functionName="grant_role(ref self: ContractState, role: felt252, account: ContractAddress)"
...
<APIItem
    functionName="grant_role_with_delay(ref self: ContractState, role: felt252, account: ContractAddress, delay: u64)"
...
<APIItem
    functionName="revoke_role(ref self: ContractState, role: felt252, account: ContractAddress)"
...
<APIItem
    functionName="renounce_role(ref self: ContractState, role: felt252, account: ContractAddress)"
...
<APIItem
    functionName="supports_interface(self: @ContractState, interface_id: felt252) → bool"
...
<APIItem
    functionName="hasRole(self: @ContractState, role: felt252, account: ContractAddress) → bool"
...
<APIItem
    functionName="getRoleAdmin(self: @ContractState, role: felt252) → felt252"
...
<APIItem
    functionName="grantRole(ref self: ContractState, role: felt252, account: ContractAddress)"
...
<APIItem
    functionName="revokeRole(ref self: ContractState, role: felt252, account: ContractAddress)"
...
<APIItem
    functionName="renounceRole(ref self: ContractState, role: felt252, account: ContractAddress)"
...
<APIItem
    functionName="initializer(ref self: ContractState)"
...
<APIItem
    functionName="assert_only_role(self: @ContractState, role: felt252)"
...
<APIItem
    functionName="is_role_effective(self: @ContractState, role: felt252, account: ContractAddress) → bool"
...
<APIItem
    functionName="resolve_role_status(self: @ContractState, role: felt252, account: ContractAddress) → RoleStatus"
...
<APIItem
    functionName="is_role_granted(self: @ContractState, role: felt252, account: ContractAddress) → bool"
...
<APIItem
    functionName="set_role_admin(ref self: ContractState, role: felt252, admin_role: felt252)"
...
<APIItem
    functionName="_grant_role(ref self: ContractState, role: felt252, account: ContractAddress)"
...
<APIItem
    functionName="_grant_role_with_delay(ref self: ContractState, role: felt252, account: ContractAddress, delay: u64)"
...
<APIItem
    functionName="_revoke_role(ref self: ContractState, role: felt252, account: ContractAddress)"
...
<APIItem
    functionName="default_admin(self: @ContractState) → ContractAddress"
...
<APIItem
    functionName="pending_default_admin(self: @ContractState) → (ContractAddress, u64)"
...
<APIItem
    functionName="default_admin_delay(self: @ContractState) → u64"
...
<APIItem
    functionName="pending_default_admin_delay(self: @ContractState) → (u64, u64)"
...
<APIItem
    functionName="begin_default_admin_transfer(ref self: ContractState, new_admin: ContractAddress)"
...
<APIItem
    functionName="cancel_default_admin_transfer(ref self: ContractState)"
...
<APIItem
    functionName="accept_default_admin_transfer(ref self: ContractState)"
...
<APIItem
    functionName="change_default_admin_delay(ref self: ContractState, new_delay: u64)"
...
<APIItem
    functionName="rollback_default_admin_delay(ref self: ContractState)"
...
<APIItem
    functionName="default_admin_delay_increase_wait(self: @ContractState) → u64"
...
<APIItem
    functionName="initializer(ref self: ContractState, initial_delay: u64, initial_default_admin: ContractAddress)"
...
<APIItem
    functionName="set_pending_default_admin(ref self: ContractState, new_admin: ContractAddress, new_schedule: u64)"
...
<APIItem
    functionName="set_pending_delay(ref self: ContractState, new_delay: u64, new_schedule: u64)"
...
<APIItem
    functionName="delay_change_wait(self: @ContractState, new_delay: u64) → u64"
...
<APIItem
    functionName="RoleAdminChanged(role: felt252, previous_admin_role: felt252, new_admin_role: felt252)"
