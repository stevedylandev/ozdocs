...
See [ERC20Component](/contracts-cairo/alpha/api/erc20#erc20component) as an example which includes:
...
Let’s look at how a contract would integrate [OwnableComponent](/contracts-cairo/alpha/api/access#OwnableComponent):
...
Here’s an example of how to use the Immutable Component Config pattern with the [ERC2981Component](/contracts-cairo/alpha/api/token_common#erc2981component):
...
For instance, [AccessControlComponent](/contracts-cairo/alpha/api/access#accesscontrolcomponent) depends on [SRC5Component](/contracts-cairo/alpha/api/introspection#src5component).
...
Next, the contract includes the [ERC20Component](/contracts-cairo/alpha/api/erc20#erc20component) implementations; however, `ERC20Impl` and `ERC20CamelOnlyImpl` are **not** embedded.
