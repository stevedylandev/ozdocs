...
<APIGithubLinkHeader moduleName="IERC2981" link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${UMBRELLA_VERSION}/packages/interfaces/src/token/erc2981.cairo`} />
...
<APIGithubLinkHeader moduleName="IERC2981Info" link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${UMBRELLA_VERSION}/packages/interfaces/src/token/erc2981.cairo`} />
...
<APIGithubLinkHeader moduleName="IERC2981Admin" link={`https://github.com/OpenZeppelin/cairo-contracts/blob/${UMBRELLA_VERSION}/packages/interfaces/src/token/erc2981.cairo`} />
