...
The following interface represents the full ABI of the Contracts for Cairo [ERC20Component](/contracts-cairo/alpha/api/erc20#ERC20Component).
The interface includes the [IERC20](/contracts-cairo/alpha/api/erc20#IERC20) standard interface as well as the optional [IERC20Metadata](/contracts-cairo/alpha/api/erc20#IERC20Metadata).
