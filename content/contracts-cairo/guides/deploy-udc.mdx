...
[Counterfactual Deployments](guides/deployment) guide. Continuing with the **sncast** examples, you can create and deploy the bootstrapper with the following commands:
