...
Since the `migrate` function will be publicly callable, it should include some sort of [Access Control](/contracts-cairo/1.0.0/access) so that only permitted addresses can execute the migration.
