...
is why its [balance_of](api/erc1155#IERC1155-balance_of) function differs from ERC20’s and ERC777’s: it has an additional ID argument for the
...
non-fungible and exists or doesn’t. The ERC721 [balance_of](api/erc721#IERC721-balance_of) function refers to how many different tokens an account
