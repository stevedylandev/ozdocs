...
NOTE: The `amount` is capped to the balance of the `user` to ensure the [`IERC7943.Frozen`](interfaces#IERC7943-Frozen-address-uint256-uint256-) event
...
NOTE: This function uses [`ERC20Allowlist._update`](#ERC20Allowlist-_update-address-address-uint256-) to perform the transfer, ensuring all standard ERC20
