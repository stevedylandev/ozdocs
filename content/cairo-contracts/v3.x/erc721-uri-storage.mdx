...
In order to make an [ERC-721](erc721.mdx) token with [URI Storage](https://docs.rs/openzeppelin-stylus/0.3.0-rc.1/openzeppelin_stylus/token/erc721/extensions/uri_storage/index.html) flavour,
your token should also use [`ERC-721 Metadata`](https://docs.rs/openzeppelin-stylus/0.3.0-rc.1/openzeppelin_stylus/token/erc721/extensions/metadata/index.html) extension to provide additional metadata for each token.
