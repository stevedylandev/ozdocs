...
In order to make an [ERC-1155](erc1155.mdx) token with [URI Storage](https://docs.rs/openzeppelin-stylus/0.3.0-rc.1/openzeppelin_stylus/token/erc1155/extensions/uri_storage/index.html) flavour,
your token should also use [`ERC-1155 Metadata URI`](https://docs.rs/openzeppelin-stylus/0.3.0-rc.1/openzeppelin_stylus/token/erc1155/extensions/metadata_uri/index.html) extension to provide additional URI metadata for each token.
