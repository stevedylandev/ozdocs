...
In order to have [`ERC-20 Permit`](https://docs.rs/openzeppelin-stylus/0.3.0-rc.1/openzeppelin_stylus/token/erc20/extensions/permit/index.html) token, you need to use only this contract without [ERC-20](erc20.mdx) as follows:
