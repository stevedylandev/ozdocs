...
In order to make [`ERC-721 Metadata`](https://docs.rs/openzeppelin-stylus/0.3.0-rc.1/openzeppelin_stylus/token/erc721/extensions/metadata/index.html)  methods “external” so that other contracts can call them, you need to add the following code to your contract:
