...
Achieving this type of deployment necessitates that the origin sets `not_from_zero` to `true` in the [deploy_contract](/api/udc.mdx#UniversalDeployer-deploy_contract) call.
