...
In order to make [`VestingWallet`](https://docs.rs/openzeppelin-stylus/0.3.0-rc.1/openzeppelin_stylus/finance/vesting_wallet/index.html) methods “external” so that other contracts can call them, you need to implement them by yourself for your final contract as follows:
