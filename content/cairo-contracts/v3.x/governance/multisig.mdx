...
Integrating the Multisig functionality into a contract requires implementing [MultisigComponent](api/governance.mdx#MultisigComponent).
...
This is the interface of a contract implementing the [MultisigComponent](api/governance.mdx#MultisigComponent):
