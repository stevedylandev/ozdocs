...
In order to make [`ERC-4626`](https://docs.rs/openzeppelin-stylus/0.3.0-rc.1/openzeppelin_stylus/token/erc20/extensions/erc4626/index.html) methods “external” so that other contracts can call them, you need to implement them by yourself for your final contract as follows:
