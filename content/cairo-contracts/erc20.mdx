...
See the [Customizing decimals](/erc20.mdx#customizing_decimals) guide.
...
<Callout>
For a more complete guide on ERC20 token mechanisms, see [Creating ERC20 Supply](/guides/erc20-supply.mdx).
</Callout>

## Interface

The following interface represents the full ABI of the Contracts for Cairo [ERC20Component](/api/erc20.mdx#ERC20Component).
The interface includes the [IERC20](/api/erc20.mdx#IERC20) standard interface as well as the optional [IERC20Metadata](/api/erc20.mdx#IERC20Metadata).

To support older token deployments, as mentioned in [Dual interfaces](/interfaces.mdx#dual_interfaces), the component also includes an implementation of the interface written in camelCase.
...
* The component offers a [dual interface](/interfaces.mdx#dual_interfaces) which supports both snake_case and camelCase methods, as opposed to just camelCase in Solidity.
