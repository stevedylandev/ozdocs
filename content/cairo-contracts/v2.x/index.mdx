...
**A library for secure smart contract development** written in Cairo for [Starknet](https://starkware.co/product/starknet/). This library consists of a set of [reusable components](components.adoc) to build custom smart contracts, as well as
ready-to-deploy [presets](presets.adoc). You can also find other [utilities](/api/utilities.adoc) including [interfaces and dispatchers](interfaces.adoc) and [test utilities](/api/testing.adoc)
...
See the [Versioning of the sub-packages](index.adoc#versioning_of_the_sub_packages) section for more information.
</Callout>
...
This is how it looks to build an ERC20 contract using the [ERC20 component](erc20.adoc).
