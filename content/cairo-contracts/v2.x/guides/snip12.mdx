...
description: SNIP12 and Typed Messages
---
...
using these utilities for on-chain signature verification. For that, let’s build an example with a custom [ERC20](/api/erc20.adoc#ERC20) contract
...
Let’s start with a basic ERC20 contract leveraging the [ERC20Component](/api/erc20.adoc#ERC20Component), and let’s add the new function.
