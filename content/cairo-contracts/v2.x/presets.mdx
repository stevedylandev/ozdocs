...
**🔥 CAUTION**
Before version 3.0.0-alpha.0, class hashes were computed using the `scarb --dev` profile.

| Name | Sierra Class Hash |
| --- | --- |
| [`AccountUpgradeable`](/api/account.adoc#AccountUpgradeable) | `AccountUpgradeable-class-hash` |
| [`ERC20Upgradeable`](/api/erc20.adoc#ERC20Upgradeable) | `ERC20Upgradeable-class-hash` |
| [`ERC721Upgradeable`](/api/erc721.adoc#ERC721Upgradeable) | `ERC721Upgradeable-class-hash` |
| [`ERC1155Upgradeable`](/api/erc1155.adoc#ERC1155Upgradeable) | `ERC1155Upgradeable-class-hash` |
| [`EthAccountUpgradeable`](/api/account.adoc#EthAccountUpgradeable) | `EthAccountUpgradeable-class-hash` |
| [`UniversalDeployer`](/api/udc.adoc#UniversalDeployer) | `UniversalDeployer-class-hash` |
| [`VestingWallet`](/api/finance.adoc#VestingWallet) | `VestingWallet-class-hash` |
...
Start by [setting up a project](index.adoc#set_up_your_project) and [installing the Contracts for Cairo library](index.adoc#install_the_library).
Copy the target preset contract from the [presets directory](https://github.com/OpenZeppelin/cairo-contracts/blob/release-v3.0.0-alpha.0/packages/presets/src) and paste it in the new project's `src/lib.cairo` like this:
