...
The following interface represents the full ABI of the Contracts for Cairo [ERC4626Component](/api/erc20.adoc#ERC4626Component).
The full interface includes the [IERC4626](/api/erc20.adoc#IERC4626), [IERC20](/api/erc20.adoc#IERC20), and [IERC20Metadata](/api/erc20.adoc#IERC20Metadata) interfaces.
