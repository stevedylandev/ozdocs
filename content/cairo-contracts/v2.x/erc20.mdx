...
To support older token deployments, as mentioned in [Dual interfaces](#dual-interfaces), the component also includes an implementation of the interface written in camelCase.
...
* The component offers a [dual interface](#dual-interfaces) which supports both snake_case and camelCase methods, as opposed to just camelCase in Solidity.
