...
compliant with the ERC4626 requirements regarding the preview functions. Fees are calculated through the [FeeConfigTrait](/api/erc20.mdx#ERC4626Component-FeeConfigTrait) 
...
See the updated [FeeConfigTrait](/api/erc20.mdx#ERC4626Component-FeeConfigTrait) and implementation examples in [ERC4626 mocks](https://github.com/OpenZeppelin/cairo-contracts/tree/main/packages/test_common/src/mocks/erc4626.cairo).
...
The following interface represents the full ABI of the Contracts for Cairo [ERC4626Component](/api/erc20.mdx#ERC4626Component).
The full interface includes the [IERC4626](/api/erc20.mdx#IERC4626), [IERC20](/api/erc20.mdx#IERC20), and [IERC20Metadata](/api/erc20.mdx#IERC20Metadata) interfaces.
