...
If you are using OpenZeppelin Defender, see [OpenZeppelin Defender with Hardhat](defender-deploy) for how to use it for deployments.

## API

See [Hardhat Upgrades API](api-hardhat-upgrades) for the full API documentation.
