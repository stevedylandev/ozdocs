...
You can read more about how to make storage-compatible changes to an implementation contract [here](upgrades::writing-upgradeable#modifying-your-contracts).
