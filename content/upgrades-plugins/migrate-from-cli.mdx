...
With Hardhat, we would write a script (**you can read more about Hardhat scripts [here](https://hardhat.org/guides/scripts.html) and about using the `hardhat-upgrades` plugin [here](hardhat-upgrades)**):
...
With Truffle, we would write a migration (**you can read more about Truffle migrations [here](https://www.trufflesuite.com/docs/truffle/getting-started/running-migrations) and about using the `truffle-upgrades` plugin [here](truffle-upgrades)**):
