...
<Callout>
This document is better viewed at https://docs.openzeppelin.com/confidential-contracts/api#governance
</Callout>
...
## `VotesConfidential` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v0.1.0/contracts/governance/utils/VotesConfidential.sol)
