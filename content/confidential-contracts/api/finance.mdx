...
## `ERC7821WithExecutor` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v0.2.0/contracts/finance/ERC7821WithExecutor.sol)
...
## `VestingWalletCliffConfidential` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v0.2.0/contracts/finance/VestingWalletCliffConfidential.sol)
...
## `VestingWalletConfidential` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v0.2.0/contracts/finance/VestingWalletConfidential.sol)
...
[`IERC7984`](interfaces#IERC7984) contract.
...
## `VestingWalletConfidentialFactory` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v0.2.0/contracts/finance/VestingWalletConfidentialFactory.sol)
