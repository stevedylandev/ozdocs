...
## `FHESafeMath` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v0.1.0/contracts/utils/FHESafeMath.sol)
...
## `HandleAccessManager` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v0.1.0/contracts/utils/HandleAccessManager.sol)
...
## `CheckpointsConfidential` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v0.1.0/contracts/utils/structs/CheckpointsConfidential.sol)
...
## `Checkpoints` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v0.1.0/contracts/utils/structs/temporary-Checkpoints.sol)
