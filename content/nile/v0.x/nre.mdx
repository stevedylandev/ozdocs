...
* `**account**`
  ...
  An [Account](#account_api) instance matching the signer.
...
* `**accounts**`
  ...
  A list of registered [Accounts](#account_api).
...
* `**transaction**`
  ...
  A [Transaction](#transaction_api) instance.
...
Return a Transaction instance representing a deploy through UDC transaction. See the [Universal Deployer Contract](https://docs.openzeppelin.com/contracts-cairo/udc#api_specification#) documentation.
