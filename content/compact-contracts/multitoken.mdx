---
title: MultiToken
description: MultiToken
---

MultiToken is a specification for contracts that manage multiple token types.
This module is an approximation of [EIP-1155](https://eips.ethereum.org/EIPS/eip-1155) written in the Compact programming language for the Midnight network.
...
[ERC165](https://eips.ethereum.org/EIPS/eip-165) (or an equivalent thereof) is NOT included in the contract.
...
Exposing [_mint](/api/multitoken.mdx#MultiTokenModule-_mint) without some sort of access control, for example, would allow ANYONE to mint tokens.
