...
In order to make [`ERC-20 Capped`](https://docs.rs/openzeppelin-stylus/0.3.0/openzeppelin_stylus/token/erc20/extensions/capped/index.html) methods supervising the supply of tokens, you need to add them by yourself for your final contract as follows:
