...
Consecutive extension for [ERC-721](/contracts-stylus/0.1.0/erc721) is useful for efficiently minting multiple tokens in a single transaction. This can significantly reduce gas costs and improve performance when creating a large number of tokens at once.
