...
Additionally, you need to ensure proper initialization during [contract deployment](deploy). Make sure to include the following code in your Solidity Constructor:
