...
The OpenZeppelin [ERC-721](/contracts-stylus/0.1.0/erc721) URI Storage extension is needed to manage and store URIs for individual tokens. This extension allows each token to have its own unique URI,
...
In order to make an [ERC-721](/contracts-stylus/0.1.0/erc721) token with [URI Storage](https://docs.rs/openzeppelin-stylus/0.1.0/openzeppelin_stylus/token/erc721/extensions/uri_storage/index.html) flavour,
