...
In order to make an [ERC-721](erc721) token with [URI Storage](https://docs.rs/openzeppelin-stylus/0.1.0/openzeppelin_stylus/token/erc721/extensions/uri_storage/index.html) flavour,
...
Additionally, you need to ensure proper initialization during [contract deployment](deploy).
