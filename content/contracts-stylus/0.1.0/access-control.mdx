...
Here’s a simple example of using `AccessControl` in an [ERC-20 token](/contracts-stylus/0.1.0/erc20) to define a 'minter' role, which allows accounts that have it create new tokens. Note that the example is unassuming of the way you construct your contract.
