---
title: ERC-20 Pausable
description: ERC-20 Pausable
---
...
In order to make your ERC20 token `pausable`, you need to use the [`Pausable`](https://docs.rs/openzeppelin-stylus/0.3.0-alpha.1/openzeppelin_stylus/utils/pausable/index.html) contract and apply its mechanisms to ERC20 token functions as follows:
