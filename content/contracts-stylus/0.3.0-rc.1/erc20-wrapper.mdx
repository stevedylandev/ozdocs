---
title: ERC-20 Wrapper
description: ERC-20 Wrapper
---
...
In order to make [`ERC20Wrapper`](https://docs.rs/openzeppelin-stylus/0.3.0-alpha.1/openzeppelin_stylus/token/erc20/extensions/wrapper/index.html) methods “external” so that other contracts can call them, you need to implement them by yourself for your final contract as follows:
