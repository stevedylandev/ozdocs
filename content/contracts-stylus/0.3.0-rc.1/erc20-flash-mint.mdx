...
description: ERC-20 Flash Mint
---

Extension of [ERC-20](erc20.mdx) that provides flash loan support at the token level.

## Usage

In order to make [`ERC-20 Flash Mint`](https://docs.rs/openzeppelin-stylus/0.3.0-alpha.1/openzeppelin_stylus/token/erc20/extensions/flash_mint/index.html)  methods “external” so that other contracts can call them, you need to add the following code to your contract:
