---
title: ERC-20 Capped
description: ERC-20 Capped
---

Extension of [ERC-20](erc20.mdx) that adds a cap to the supply of tokens.

## Usage

In order to make [`ERC-20 Capped`](https://docs.rs/openzeppelin-stylus/0.3.0-alpha.1/openzeppelin_stylus/token/erc20/extensions/capped/index.html) methods supervising the supply of tokens, you need to add them by yourself for your final contract as follows:
