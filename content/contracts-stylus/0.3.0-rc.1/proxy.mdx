...
* [ERC-1967 Proxy](erc1967.mdx): A standardized proxy pattern with specific storage slots.
* [Beacon Proxy](beacon-proxy.mdx): Multiple proxies pointing to a single beacon contract for mass upgrades of the implementation contract address.
* [UUPS Proxy](uups-proxy.mdx): The Universal Upgradeable Proxy Standard (UUPS) that is a minimal and gas-efficient pattern for upgradeable contracts.
