...
description: ERC-1155 Supply
---

The OpenZeppelin [ERC-1155](erc1155.mdx) Supply extension that adds tracking of total supply per token id.
Useful for scenarios where Fungible and Non-fungible tokens have to be clearly identified.

## Usage

In order to make an [ERC-1155](erc1155.mdx) token with [Supply](https://docs.rs/openzeppelin-stylus/0.3.0-alpha.1/openzeppelin_stylus/token/erc1155/extensions/supply/index.html) flavour,
