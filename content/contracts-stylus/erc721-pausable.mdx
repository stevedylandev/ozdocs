---
title: ERC-721 Pausable
description: ERC-721 Pausable
---
...
In order to make your ERC721 token `pausable`, you need to use the [`Pausable`](https://docs.rs/openzeppelin-stylus/0.3.0-alpha.1/openzeppelin_stylus/utils/pausable/index.html) contract and apply its mechanisms to ERC721 token functions as follows:
