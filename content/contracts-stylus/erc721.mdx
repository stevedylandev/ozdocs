...
Check out the [`API reference`](https://docs.rs/openzeppelin-stylus/0.3.0/openzeppelin_stylus/token/erc721/struct.Erc721.html) to learn more about these.
...
The [`Erc721Metadata`](https://docs.rs/openzeppelin-stylus/0.3.0/openzeppelin_stylus/token/erc721/extensions/metadata/struct.Erc721Metadata.html) contract is an extension contract of ERC-721.
