...
In order to make an [ERC-721](erc721) token with [Enumerable](https://docs.rs/openzeppelin-stylus/0.3.0-alpha.1/openzeppelin_stylus/token/erc721/extensions/enumerable/index.html) flavour,
