...
Extension of [ERC-1155](/contracts-stylus/0.2.0/erc1155) that allows token holders to destroy both their
own tokens and those that they have been approved to use.

## Usage

In order to make [`ERC-1155 Burnable`](https://docs.rs/openzeppelin-stylus/0.2.0/openzeppelin_stylus/token/erc1155/extensions/burnable/index.html) methods “external” so that other contracts can call them, you need to implement them by yourself for your final contract as follows:
