...
Extension of [ERC-721](/contracts-stylus/0.2.0/erc721) that adds the optional metadata functions from the ERC721 standard.

## Usage

In order to make [`ERC-721 Metadata`](https://docs.rs/openzeppelin-stylus/0.2.0/openzeppelin_stylus/token/erc721/extensions/metadata/index.html)  methods “external” so that other contracts can call them, you need to add the following code to your contract:
