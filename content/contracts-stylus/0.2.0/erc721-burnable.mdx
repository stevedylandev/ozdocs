...
[ERC-721](/contracts-stylus/0.2.0/erc721) Token that can be burned (destroyed).

## Usage

In order to make [`ERC-721 Burnable`](https://docs.rs/openzeppelin-stylus/0.2.0/openzeppelin_stylus/token/erc721/extensions/burnable/index.html) methods “external” so that other contracts can call them, you need to implement them by yourself for your final contract as follows:
