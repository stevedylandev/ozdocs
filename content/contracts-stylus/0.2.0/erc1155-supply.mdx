...
The OpenZeppelin [ERC-1155](/contracts-stylus/0.2.0/erc1155) Supply extension that adds tracking of total supply per token id.
Useful for scenarios where Fungible and Non-fungible tokens have to be clearly identified.

## Usage

In order to make an [ERC-1155](/contracts-stylus/0.2.0/erc1155) token with [Supply](https://docs.rs/openzeppelin-stylus/0.2.0/openzeppelin_stylus/token/erc1155/extensions/supply/index.html) flavour,
