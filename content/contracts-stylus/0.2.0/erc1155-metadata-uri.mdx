...
The OpenZeppelin [ERC-1155](/contracts-stylus/0.2.0/erc1155) Metadata URI extension is needed to manage and store URIs for individual tokens. This extension allows each token to have its own unique URI,
...
In order to make an [ERC-1155](/contracts-stylus/0.2.0/erc1155) token with [Metadata URI](https://docs.rs/openzeppelin-stylus/0.2.0/openzeppelin_stylus/token/erc1155/extensions/metadata_uri/index.html) flavour,
