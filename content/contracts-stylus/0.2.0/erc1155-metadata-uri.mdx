...
In order to make an [ERC-1155](erc1155.mdx) token with [Metadata URI](https://docs.rs/openzeppelin-stylus/0.2.0/openzeppelin_stylus/token/erc1155/extensions/metadata_uri/index.html) flavour,
