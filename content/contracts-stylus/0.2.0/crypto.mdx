...
[`MerkleProof`](https://docs.rs/openzeppelin-crypto/0.2.0/openzeppelin_crypto/merkle/struct.Verifier.html) provides:

* [`verify`](https://docs.rs/openzeppelin-crypto/0.2.0/openzeppelin_crypto/merkle/struct.Verifier.html#method.verify) - can prove that some value is part of a [Merkle tree](https://en.wikipedia.org/wiki/Merkle_tree).
* [`verify_multi_proof`](https://docs.rs/openzeppelin-crypto/0.2.0/openzeppelin_crypto/merkle/struct.Verifier.html#method.verify_multi_proof) - can prove multiple values are part of a Merkle tree.
...
We also provide an adapter [`hash`](https://docs.rs/openzeppelin-crypto/0.2.0/openzeppelin_crypto/hash/index.html) module to use your own hashers in conjunction with them that resembles Rust’s standard library’s API.
