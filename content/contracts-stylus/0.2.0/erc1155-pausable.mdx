...
In order to make your [ERC-1155](erc1155) token `pausable`, you need to use the [`Pausable`](https://docs.rs/openzeppelin-stylus/0.2.0/openzeppelin_stylus/utils/pausable/index.html) contract and apply its mechanisms to ERC1155 token functions as follows:
