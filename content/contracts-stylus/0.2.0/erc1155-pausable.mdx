...
[ERC-1155](/contracts-stylus/0.2.0/erc1155) token with pausable token transfers, minting, and burning.

Useful for scenarios such as preventing trades until the end of an evaluation period, or having an emergency switch for freezing all token transfers in the event of a large bug.

## Usage

In order to make your [ERC-1155](/contracts-stylus/0.2.0/erc1155) token `pausable`, you need to use the [`Pausable`](https://docs.rs/openzeppelin-stylus/0.2.0/openzeppelin_stylus/utils/pausable/index.html) contract and apply its mechanisms to ERC1155 token functions as follows:
