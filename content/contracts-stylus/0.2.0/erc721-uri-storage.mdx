...
In order to make an [ERC-721](erc721.mdx) token with [URI Storage](https://docs.rs/openzeppelin-stylus/0.2.0/openzeppelin_stylus/token/erc721/extensions/uri_storage/index.html) flavour,
