...
Extension of [ERC-20](/contracts-stylus/0.2.0/erc20) that adds a cap to the supply of tokens.

## Usage

In order to make [`ERC-20 Capped`](https://docs.rs/openzeppelin-stylus/0.2.0/openzeppelin_stylus/token/erc20/extensions/capped/index.html) methods supervising the supply of tokens, you need to add them by yourself for your final contract as follows:
