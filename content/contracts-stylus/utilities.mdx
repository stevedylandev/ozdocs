...
For a complete list, check out the [API Reference](https://docs.rs/openzeppelin-stylus/0.3.0-alpha.1/openzeppelin_stylus/utils/index.html).
...
* [`BitMaps`](https://docs.rs/openzeppelin-stylus/0.3.0-alpha.1/openzeppelin_stylus/utils/structs/bitmap/index.html): Store packed booleans in storage.
* [`Checkpoints`](https://docs.rs/openzeppelin-stylus/0.3.0-alpha.1/openzeppelin_stylus/utils/structs/checkpoints/index.html): Checkpoint values with built-in lookups.
* [`EnumerableSets`](https://docs.rs/openzeppelin-stylus/0.3.0-alpha.1/openzeppelin_stylus/utils/structs/enumerable_set/index.html): Contract for managing sets of many primitive types.
