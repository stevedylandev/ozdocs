...
<Callout>
Only for upgrading existing deployments using OpenZeppelin Contracts v4.
</Callout>
...
### ``UnsafeUpgrades`` link:https://github.com/OpenZeppelin/openzeppelin-foundry-upgrades/blob/main/src/LegacyUpgrades.sol[pass:[<svg class="icon"><use href="#github-icon"/></svg>],role=heading-link]
