...
### `Options` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v0.4.0/src/Options.sol)
...
### `DefenderOptions` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v0.4.0/src/Options.sol)
...
### `TxOverrides` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v0.4.0/src/Options.sol)
...
### `Upgrades` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v0.4.0/src/Upgrades.sol)
...
### `UnsafeUpgrades` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v0.4.0/src/Upgrades.sol)
...
### `UnsafeUpgrades` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v0.4.0/src/LegacyUpgrades.sol)
...
### `Defender` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v0.4.0/src/Defender.sol)
...
### `ProposeUpgradeResponse` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v0.4.0/src/Defender.sol)
...
### `ApprovalProcessResponse` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v0.4.0/src/Defender.sol)
