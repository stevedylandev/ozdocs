...
description: Using with Foundry
---
...
If you are using OpenZeppelin Defender, see [OpenZeppelin Defender with Foundry](foundry-defender.mdx) for how to use it for deployments.

## API

See [Foundry Upgrades API](api-foundry-upgrades.mdx) for the full API documentation.
