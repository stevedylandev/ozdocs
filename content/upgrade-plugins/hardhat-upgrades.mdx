...
description: Using with Hardhat
---
...
If you are using OpenZeppelin Defender, see [OpenZeppelin Defender with Hardhat](defender-deploy.mdx) for how to use it for deployments.

## API

See [Hardhat Upgrades API](api-hardhat-upgrades.mdx) for the full API documentation.
