...
description: Migrate from OpenZeppelin CLI
---
...
With Hardhat, we would write a script (**you can read more about Hardhat scripts [here](https://hardhat.org/guides/scripts.html) and about using the `hardhat-upgrades` plugin [here](https://docs.openzeppelin.com/upgrades-plugins/1.x/hardhat-upgrades)**):
