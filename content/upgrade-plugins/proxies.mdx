...
description: Proxy Upgrade Pattern
---

This article describes the "unstructured storage" proxy pattern, the fundamental building block of OpenZeppelin Upgrades.

<Callout>
For a more in depth read, please see [our proxy-patterns blog post](https://blog.openzeppelin.com/proxy-patterns/), which discusses the need for proxies, goes into more technical detail on the subject, elaborates on other possible proxy patterns that were considered for OpenZeppelin Upgrades, and more.
</Callout>
