...
If you’re new to the GSN, you probably want to first take a look at the [overview of the system](/contracts/5.x/learn/sending-gasless-transactions) to get a clearer picture of how gasless transactions are achieved. Otherwise, strap in!
