...
* [RevokedOperator(operator, tokenHolder)](#ERC20PresetMinterPauser-constructor-string-string-[`+constructor(name, symbol)+`]
* [AuthorizedOperator(operator, tokenHolder)](#ERC20PresetMinterPauser-mint-address-uint256-[`+mint(to, amount)+`]
...
* [constructor(name, symbol, baseURI)](#ERC721PresetMinterPauserAutoId-constructor)]
...
* [constructor(uri)](#ERC1155PresetMinterPauser-constructor)]
...
[Batched](ROOT:erc1155.mdx#batch-operations) variant of pass:normal[[``mint``](#`mint(address-to,-uint256-id,-uint256-amount,-bytes-data) *public*`)].
...
* [constructor(name, symbol, initialSupply, owner)](#ERC20PresetFixedSupply-constructor)]
...
* [constructor(name, symbol, defaultOperators, initialSupply, owner)](#ERC777PresetFixedSupply-constructor)]
...
* xref-IERC777-AuthorizedOperator-address-address)]
* xref-IERC777-RevokedOperator-address-address)]
