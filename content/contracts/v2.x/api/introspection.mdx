...
* [_registerInterfaceForAddress(interfaceHash, account)](#IERC165-supportsInterface-bytes4-[`+supportsInterface(interfaceId)+`]
...
* [canImplementInterfaceForAddress(interfaceHash, account)](#ERC165-constructor)
...
* xref-ERC1820Implementer-canImplementInterfaceForAddress-bytes32-address)]
* xref-ERC1820Implementer-_registerInterfaceForAddress-bytes32-address)]
