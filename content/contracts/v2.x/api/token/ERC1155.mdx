...
* [_registerInterface(interfaceId)](#IERC1155-balanceOf-address-uint256)
* [supportsInterface(interfaceId)](#IERC1155-balanceOfBatch-address---uint256---)
...
* [constructor(uri_)](#ERC1155-constructor)]
...
See pass:normal[[``uri``](#`uri(uint256) → string *external*`)].
...
[Batched](ROOT:erc1155.mdx#batch-operations) version of pass:normal[[``_mint``](#`_mint(address-account,-uint256-id,-uint256-amount,-bytes-data) *internal*`)].
...
[Batched](ROOT:erc1155.mdx#batch-operations) version of pass:normal[[``_burn``](#`_burn(address-account,-uint256-id,-uint256-amount) *internal*`)].
...
* xref-ERC165-supportsInterface-bytes4)]
* xref-ERC165-_registerInterface-bytes4)]
