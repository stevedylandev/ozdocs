...
* [tokensReceived(operator, from, to, amount, userData, operatorData)](#IERC777-name)
* [tokensToSend(operator, from, to, amount, userData, operatorData)](#IERC777-symbol)
* [RevokedOperator(operator, tokenHolder)](#IERC777-granularity)
...
that a supply mechanism has to be added in a derived contract using pass:normal[[``_mint``](#`_mint(address-account,-uint256-amount,-bytes-userdata,-bytes-operatordata) *internal*`)].
...
calls to pass:normal[[``send``](#`send(address-recipient,-uint256-amount,-bytes-data) *public*`)], pass:normal[[``transfer``](#`transfer(address-recipient,-uint256-amount) → bool *public*`)], operatorSend, minting and burning.
...
* xref-IERC777Sender-tokensToSend-address-address-address-uint256-bytes-bytes)]
...
* xref-IERC777Recipient-tokensReceived-address-address-address-uint256-bytes-bytes)]
