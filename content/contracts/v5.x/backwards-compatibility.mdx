...
See [Extending Contracts](extending-contracts.adoc) for more about virtual and overrides.
...
We recommend using [OpenZeppelin Upgrades Plugins or CLI](upgrades-plugins::index.adoc) to ensure storage layout safety of upgrades.
