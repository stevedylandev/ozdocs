...
Read our [guide on the payment strategies](gsn-strategies.mdx) pre-built and shipped in OpenZeppelin Contracts, or check out [the API reference of the GSN base contracts](contracts/v3.x/api/GSN.mdx).
