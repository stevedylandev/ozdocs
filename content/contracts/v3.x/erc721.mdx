...
The [`ERC721`](contracts/v3.x/api/token/ERC721.mdx#ERC721) contract includes all standard extensions ([`IERC721Metadata`](contracts/v3.x/api/token/ERC721.mdx#IERC721Metadata) and [`IERC721Enumerable`](contracts/v3.x/api/token/ERC721.mdx#IERC721Enumerable)). That’s where the [`_setTokenURI`](contracts/v3.x/api/token/ERC721.mdx#ERC721-_setTokenURI-uint256-string-) method comes from: we use it to store an item’s metadata.
