...
* [`ERC20Snapshot`](/contracts/4.x/api/token/ERC20#ERC20Snapshot): moved to `token/ERC20`.
...
* [`Counters`](/contracts/4.x/api/utils#Counters): moved to [`utils`](/contracts/4.x/api/utils).
* [`Strings`](/contracts/4.x/api/utils#Strings): moved to [`utils`](/contracts/4.x/api/utils).
* [`SignedSafeMath`](/contracts/4.x/api/utils#SignedSafeMath): moved to [`utils`](/contracts/4.x/api/utils).
