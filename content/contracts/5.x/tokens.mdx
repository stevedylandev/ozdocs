...
* [ERC-20](erc20.adoc): the most widespread token standard for fungible assets, albeit somewhat limited by its simplicity.
* [ERC-721](erc721.adoc): the de-facto solution for non-fungible tokens, often used for collectibles and games.
* [ERC-1155](erc1155.adoc): a novel standard for multi-tokens, allowing for a single contract to represent multiple fungible and non-fungible tokens, along with batched operations for increased gas efficiency.
