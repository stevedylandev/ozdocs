...
<Callout type="tip">
Use [`ERC4337Utils`](contracts/v5.x/api/account#ERC4337Utils) to manipulate the `UserOperation` struct and other ERC-4337 related values.
</Callout>
...
<Callout>
The `IAccountExecute` interface is optional. Developers might want to use [`ERC-7821`](contracts/v5.x/api/account#ERC7821) for a minimal batched execution interface or rely on ERC-7579 or any other execution logic.
</Callout>
