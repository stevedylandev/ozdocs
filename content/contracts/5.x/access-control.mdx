...
Here’s a simple example of an [ERC-20 token](tokens#ERC20) that defines a `mint` function that is restricted by an [`AccessManager`](contracts/v5.x/api/access#AccessManager):
