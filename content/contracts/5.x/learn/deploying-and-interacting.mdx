...
With our project setup complete we're now ready to deploy a contract. We'll be deploying `Box`, from the [Developing Smart Contracts](./developing-smart-contracts#box-contract) guide. Make sure you have a copy of [Box](./developing-smart-contracts#box-contract) in `contracts/Box.sol`.
