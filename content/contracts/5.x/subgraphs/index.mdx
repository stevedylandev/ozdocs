...
Install from npm as [`@openzeppelin/subgraphs`](https://www.npmjs.com/package/@openzeppelin/subgraphs).

Browse on GitHub at [`OpenZeppelin/openzeppelin-subgraphs`](https://github.com/OpenZeppelin/openzeppelin-subgraphs).
...
Similar to the manifest, `@amxx/graphprotocol-utils` provides tooling to [automate the generation of schemas.](/contracts/5.x/subgraphs/generate)
