...
<div className="border rounded-md mb-4">
<div className="bg-secondary flex w-full justify-between px-4">
<p className="font-bold text-sm font-mono">_validateUserOp(struct PackedUserOperation userOp, bytes32 userOpHash) → uint256</p>
<div className="flex flex-row items-center gap-2">
<p className="font-light text-sm">internal</p>
<a className="peer" data-card href="Account-_validateUserOp-struct-PackedUserOperation-bytes32-">#</a>
</div>
</div>
<div className="px-4">
...
<div className="flex flex-row items-center gap-2">
<p className="font-light text-sm">internal</p>
<a className="peer" data-card href="AccountERC7579-_validateUserOp-struct-PackedUserOperation-bytes32-">#</a>
</div>
</div>
<div className="px-4">
