...
<Callout>
For an overview of ERC-20 tokens and a walk through on how to create a token contract read our [ERC-20 guide](ROOT:erc20).
</Callout>
...
NOTE: This function is not virtual, [`ERC1155._update`](ERC1155#ERC1155-_update-address-address-uint256---uint256---) should be overridden instead.
...
NOTE: When this extension is used along with the [`ERC20Capped`](#ERC20Capped) or [`ERC20Votes`](#ERC20Votes) extensions,
...
NOTE: When the recipient address (`to`) has no code (i.e. is an EOA), this function behaves as [`SafeERC20.forceApprove`](#SafeERC20-forceApprove-contract-IERC20-address-uint256-).
