...
OpenZeppelin Contracts provides many ERC20-related contracts. On the [`API reference`](contracts/v5.x/api/token/ERC20.mdx) you’ll find detailed information on their properties and usage.
...
Our contracts are often used via [inheritance](https://solidity.readthedocs.io/en/latest/contracts.html#inheritance), and here we’re reusing [`ERC20`](contracts/v5.x/api/token/ERC20.mdx#erc20) for both the basic standard implementation and the [`name`](contracts/v5.x/api/token/ERC20.mdx#ERC20-name--), [`symbol`](contracts/v5.x/api/token/ERC20.mdx#ERC20-symbol--), and [`decimals`](contracts/v5.x/api/token/ERC20.mdx#ERC20-decimals--) optional extensions. Additionally, we’re creating an `initialSupply` of tokens, which will be assigned to the address that deploys the contract.
...
We can also [transfer](contracts/v5.x/api/token/ERC20.mdx#IERC20-transfer-address-uint256-) these tokens to other accounts:
