...
By default, the [`owner`](contracts/v5.x/api/access.mdx#Ownable-owner--) of an `Ownable` contract is the account that deployed it, which is usually exactly what you want.
