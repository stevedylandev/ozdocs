...
For detailed network configuration options and examples, see the [Network Configuration](network_configuration.mdx) page.



For information about our development plans and upcoming features, see [Project Roadmap](roadmap.mdx).
...
For detailed information about each directory and its contents, see [Project Structure Details](structure.mdx).
...
<Callout>
Before executing the command, ensure that the `.env` and `config.json` files are configured as detailed in the [Configuration References](index.mdx#configuration_references) section.
</Callout>
...
See the dedicated [Configuration Guide](configuration.mdx).
