...
description: Building New Adapters
---
...
graph TD
    A[Start: Add Support for New Chain] --> BCreate New Package: packages/adapter-name
    ...
    D5 --> ERegister Adapter in Builder: packages/builder/src/core/ecosystemManager.ts
