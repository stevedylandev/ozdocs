...
![Quickstart select network](/contracts-ui-builder/quickstart-select-network.png)
...
![Quickstart contract address](/contracts-ui-builder/quickstart-contract-address.png)

### 3. Select Function

Choose which write function you would like to build a form for.

![Quickstart select function](/contracts-ui-builder/quickstart-select-function.png)
...
Check out the [Customization](customization.mdx) section for more details


![Quickstart customize form](/contracts-ui-builder/quickstart-customize-form.png)
...
![Quickstart export form](/contracts-ui-builder/quickstart-export-form.png)

## Next Steps

Learn how you can customize [networks](networks.mdx) or customize the [forms](functions.mdx) for your project.

Visit the GitHub repo with the link below and open an issue if you have any problems!

[GitHub Repo](https://github.com/OpenZeppelin/contracts-ui-builder)
