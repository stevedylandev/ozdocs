...
![Networks config button](/contracts-ui-builder/networks-config-button.png)

In this modal you can configure a custom RPC URL which can include path API key authorization

![Networks RPC settings](/contracts-ui-builder/networks-rpc-settings.png)
...
![Networks explorer settings](/contracts-ui-builder/networks-explorer-settings.png)

You can also toggle advance settings to use a custom block explorer setup.

![Networks advance settings](/contracts-ui-builder/networks-advance-settings.png)
