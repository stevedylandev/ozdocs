...
{/*
  * The first header displays on the `toc` only.
  * The second header is empty but maintains `toc` highlighting.
  * The `div` wrapper removes the excess padding from the second header.
  */}
#### hasRole [toc] [#hasRole]
#### [!toc] [#hasRole]
