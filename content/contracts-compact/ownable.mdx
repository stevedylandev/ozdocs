...
[transferOwnership]: api/ownable#transferownership
[_transferOwnership]: api/ownable#_transferownership
[_unsafeTransferOwnership]: api/ownable#_unsafetransferownership
[_unsafeUncheckedTransferOwnership]: api/ownable#_unsafeuncheckedtransferownership

This modules provides a basic access control mechanism,
where there is an owner that can be granted exclusive access to specific circuits.
