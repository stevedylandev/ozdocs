...
[_unsafeGrantRole]: api/access#_unsafegrantrole
[assertOnlyRole]: api/access#assertonlyrole
...
[_grantRole]: api/access#_grantrole
[grantRole]: api/access#grantrole
[revokeRole]: api/access#revokerole
[_setRoleAdmin]: api/access#_setroleadmin
