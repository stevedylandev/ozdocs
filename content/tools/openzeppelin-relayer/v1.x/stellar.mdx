...
description: Stellar Integration
---
...
For detailed network configuration options, see the [Network Configuration](network_configuration.mdx) guide.

## Quickstart

For a step-by-step setup, see [Quick Start Guide](quickstart.mdx).
Key prerequisites:
...
Stellar relayers support standard relayer configuration options. Check all options in [User Documentation - Relayers](index.mdx#3_relayers).
...
* See [Project Roadmap](roadmap.mdx) for upcoming features
