...
For detailed signer configuration options, see the [Signers](signers.mdx) guide.
...
You can check all options in [User Documentation - Relayers](index.mdx#3_relayers).
