...
Also, it is possible to customize the notification template, [see how](module/monitor.mdx#customizing-notification).
...
The authenticity of the signature can be validated using `verifySignature` utility function in [Defender SDK](sdk.mdx).
