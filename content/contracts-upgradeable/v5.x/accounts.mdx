...
<Callout type='warn'>
We recommend using [ERC7739](contracts/v5.x/api/utils/cryptography.mdx#ERC7739) to avoid replayability across accounts. This defensive rehashing mechanism that prevents signatures for this account to be replayed in another account controlled by the same signer. See [ERC-7739 signatures](accounts.mdx#erc_7739_signatures).
</Callout>
...
[UserOperations](account-abstraction.mdx#useroperation) are a powerful abstraction layer that enable more sophisticated transaction capabilities compared to traditional Ethereum transactions. To get started, you’ll need to an account, which you can get by [deploying a factory](accounts.mdx#accounts_factory) for your implementation.
...
<Callout>
Learn more about delegating to an ERC-7702 account in our [EOA Delegation](eoa-delegation.mdx) section.
</Callout>
