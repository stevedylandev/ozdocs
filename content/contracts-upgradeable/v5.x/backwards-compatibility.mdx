...
See [Extending Contracts](extending-contracts.mdx) for more about virtual and overrides.
...
We recommend using [OpenZeppelin Upgrades Plugins or CLI](upgrades-plugins::index.mdx) to ensure storage layout safety of upgrades.
