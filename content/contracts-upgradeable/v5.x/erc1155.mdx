...
ERC-1155 is a novel token standard that aims to take the best from previous standards to create a [**fungibility-agnostic**](tokens.mdx#different-kinds-of-tokens) and **gas-efficient** [token contract](tokens.mdx#but_first_coffee_a_primer_on_token_contracts).

<Callout>
ERC-1155 draws ideas from all of [ERC-20](erc20.mdx), [ERC-721](erc721.mdx), and [ERC-777](https://eips.ethereum.org/EIPS/eip-777). If you’re unfamiliar with those standards, head to their guides before moving on.
</Callout>
...
<Callout>
For an overview of minting mechanisms, check out [Creating ERC-20 Supply](erc20-supply.mdx).
</Callout>
