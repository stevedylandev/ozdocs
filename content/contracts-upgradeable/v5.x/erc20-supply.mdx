...
description: Creating ERC-20 Supply
---
...
The internal [`_mint`](contracts/v5.x/api/token/ERC20.mdx#ERC20-_mint-address-uint256-) function is the key building block that allows us to write ERC-20 extensions that implement a supply mechanism.
...
So far our supply mechanism was triggered manually, but `ERC20` also allows us to extend the core functionality of the token through the [`_update`](contracts/v5.x/api/token/ERC20.mdx#ERC20-_update-address-address-uint256-) function.
