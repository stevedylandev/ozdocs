...
<Callout>
To understand the inspiration for a multi token standard, see the [multi token standard](erc1155.mdx#multi-token-standard) section within the EIP-1155 docs.
</Callout>
