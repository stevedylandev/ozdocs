...
## Source Code link:https://github.com/paritytech/polkadot-sdk/blob/release-polkadot-v1.10.0/substrate/frame/balances/src/lib.rs[pass:[<svg class="icon"><use href="#github-icon"/></svg>],role=heading-link]
...
* Setting and managing [locks](/substrate-runtimes/2.0.2/glossary#lock).

## Config

* Pallet-specific configs
  * `RuntimeHoldReason` -- The overarching [hold](/substrate-runtimes/2.0.2/glossary#hold) reason.
  * `RuntimeFreezeReason` -- The overarching [freeze](/substrate-runtimes/2.0.2/glossary#freeze) reason.
  ...
  * `ReserveIdentifier` --  The ID type for [reserves](/substrate-runtimes/2.0.2/glossary#reserve). The use of reserves is deprecated in favor of holds. See `https://github.com/paritytech/substrate/pull/12951/`
