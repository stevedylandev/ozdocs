...
## Source Code link:https://github.com/paritytech/polkadot-sdk/blob/release-polkadot-v1.10.0/substrate/frame/assets/src/lib.rs[pass:[<svg class="icon"><use href="#github-icon"/></svg>],role=heading-link]
