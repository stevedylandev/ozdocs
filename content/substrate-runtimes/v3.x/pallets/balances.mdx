...
* Pallet-specific configs
  ...
  * `ReserveIdentifier` --  The ID type for [reserves](glossary.mdx#reserve). The use of reserves is deprecated in favor of holds. See [PR #12951](https://github.com/paritytech/substrate/pull/12951/)
