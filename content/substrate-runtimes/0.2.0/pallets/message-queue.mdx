---
title: pallet_message_queue
---

Branch/Release: `release-polkadot-v1.10.0`

Source Code [pass:[<svg class="icon"><use href="#github-icon"/></svg>](https://github.com/paritytech/polkadot-sdk/blob/release-polkadot-v1.10.0/substrate/frame/message-queue/src/lib.rs),role=heading-link]
