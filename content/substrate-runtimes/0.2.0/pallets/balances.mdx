...
* Setting and managing [locks](glossary.mdx#lock).

## Config

* Pallet-specific configs
  * `RuntimeHoldReason` -- The overarching [hold](glossary.mdx#hold) reason.
  * `RuntimeFreezeReason` -- The overarching [freeze](glossary.mdx#freeze) reason.
  ...
  * `ReserveIdentifier` --  The ID type for [reserves](glossary.mdx#reserve). The use of reserves is deprecated in favor of holds. See `https://github.com/paritytech/substrate/pull/12951/`
