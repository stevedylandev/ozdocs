...
* Pallet-specific configs
  ...
  * `ReserveIdentifier` --  The ID type for [reserves](glossary#reserve). The use of reserves is deprecated in favor of holds. See `https://github.com/paritytech/substrate/pull/12951/`
