...
* Move to the directory of the template you want to use. We will use the `generic runtime template` for this tutorial,but the same applies to the [EVM Runtime Template](runtimes/evm).
```bash
cd generic-template
```
