---
title: OpenZeppelin Pallet Abstractions
description: OpenZeppelin Pallet Abstractions
---
...
We encourage contributions from the community to improve the library. Please refer to the [CONTRIBUTING.md](https://github.com/OpenZeppelin/openzeppelin-pallet-abstractions/blob/main/CONTRIBUTING.MD) for guidelines.
...
```
Note: Pallet index assignments are handled automatically by this macro. If you require explicit control over pallet indices, please consider submitting a [feature request](https://github.com/OpenZeppelin/openzeppelin-pallet-abstractions/issues).
