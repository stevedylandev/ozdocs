---
title: Migrate a Contract from EVM chain
description: Migrate a Contract from EVM chain
---
...
This step is basic, you can use our [guide for generic template](index.mdx). It is recommended to use [async backing](guides/async_backing.mdx) for better experience.
...
For Solidity development you can use [Foundry](https://book.getfoundry.sh/getting-started/installation). Feel free to use any other toolkit like ethers.js or web3.py.
...
Optional: If you want to test any contract, you can use our [guide about the standard contracts](https://docs.openzeppelin.com/contracts/5.x/#foundry_git).
