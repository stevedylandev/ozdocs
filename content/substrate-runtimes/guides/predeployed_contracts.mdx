...
description: Predeployed Contracts
---
...
* [Hardhat](https://hardhat.org/hardhat-runner/docs/guides/compile-contracts)
* [Forge](https://book.getfoundry.sh/reference/forge/forge-build)
