...
* ***[Fungible Tokens](tokens/fungible.mdx)***: Digital assets representing a fixed or dynamic supply of identical units.
* ***[Non-Fungible Tokens](tokens/non-fungible.mdx)***: Unique digital assets with verifiable ownership.
