...
Enumerable extension for [Non-Fungible Token](tokens/non-fungible.mdx) allows for enumeration
...
We’ll build on the [example](tokens/non-fungible.mdx#usage) from **Non-Fungible Token**
