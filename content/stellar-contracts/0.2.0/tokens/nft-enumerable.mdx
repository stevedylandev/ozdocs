...
Enumerable extension for [Non-Fungible Token](/stellar-contracts/0.2.0/tokens/non-fungible) allows for enumeration
...
We’ll build on the [example](/stellar-contracts/0.2.0/tokens/non-fungible#usage) from **Non-Fungible Token**
