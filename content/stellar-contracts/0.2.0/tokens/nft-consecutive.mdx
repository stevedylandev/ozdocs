...
Consecutive extension for [Non-Fungible Token](/stellar-contracts/0.2.0/tokens/non-fungible) is useful
...
We’ll continue with the [example](/stellar-contracts/0.2.0/tokens/non-fungible#usage) from **Non-Fungible Token**
