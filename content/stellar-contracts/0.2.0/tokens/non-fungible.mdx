...
* [Non-Fungible Consecutive](/stellar-contracts/0.2.0/tokens/nft-consecutive): Extension for optimized minting of batches of tokens.
* [Non-Fungible Enumerable](/stellar-contracts/0.2.0/tokens/nft-enumerable): Extension that allows enumerating the tokens on-chain.
