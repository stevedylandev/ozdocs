...
Enumerable extension for [Non-Fungible Token](/stellar-contracts/0.3.0/tokens/non-fungible/non-fungible) allows for enumeration
...
We’ll build on the [example](/stellar-contracts/0.3.0/tokens/non-fungible/non-fungible#usage) from **Non-Fungible Token**
