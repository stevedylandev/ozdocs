...
Consecutive extension for [Non-Fungible Token](/stellar-contracts/0.3.0/tokens/non-fungible/non-fungible) is useful
...
We’ll continue with the [example](/stellar-contracts/0.3.0/tokens/non-fungible/non-fungible#usage) from **Non-Fungible Token**
