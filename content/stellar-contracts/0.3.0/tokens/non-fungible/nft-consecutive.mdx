...
Consecutive extension for [Non-Fungible Token](tokens/non-fungible/non-fungible.mdx) is useful
...
We’ll continue with the [example](tokens/non-fungible/non-fungible.mdx#usage) from **Non-Fungible Token**
