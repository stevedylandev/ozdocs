...
Consecutive extension for [Non-Fungible Token](tokens/non-fungible/non-fungible) is useful
...
We’ll continue with the [example](tokens/non-fungible/non-fungible#usage) from **Non-Fungible Token**
