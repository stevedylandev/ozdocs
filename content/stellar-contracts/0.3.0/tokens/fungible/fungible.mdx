...
For detailed documentation, see [SAC Admin Generic](/stellar-contracts/0.3.0/tokens/fungible/sac-admin-generic).
...
For detailed documentation, see [SAC Admin Wrapper](/stellar-contracts/0.3.0/tokens/fungible/sac-admin-wrapper).
