...
Documentation for setting up logging with Splunk HEC can be found [here](https://docs.splunk.com/Documentation/Splunk/latest/Data/UsetheHTTPEventCollector).
...
Documentation for setting up logging on Datadog can be found [here](https://docs.datadoghq.com/logs/).
