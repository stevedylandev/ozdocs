...
description: Create an Action Workflow to decrease the number of objects in a Box contract
---
...
4. Navigate to [Defender Address Book, window=_blank](https://defender.openzeppelin.com/v2/#/address-book/new) to import the `BoxV2` contract.
5. Fill the form with the following parameters and click on **Create**:

   * **Name**: `BoxV2`
   * **Network**: `Sepolia`
   * **Address**: `0xC64f7ace6127bc7B0bAb23bD1871aC81e6AEC074`
6. Navigate to [Defender Workflows Transaction Template creation page, window=_blank](https://defender.openzeppelin.com/v2/#/actions/workflows/transaction-template/new?).
...
1. Open the [Defender Workflows creation page, window=_blank](https://defender.openzeppelin.com/v2/#/actions/workflows/new).
...
1. Open the [Defender Monitor creation page, window=_blank](https://defender.openzeppelin.com/v2/#/monitor/new/custom).
...
1. Open the [Defender Transaction Proposal creation page, window=_blank](https://defender.openzeppelin.com/v2/#/transaction-proposals/new?).
...
3. Wait for the transaction to be executed and open the [Defender Workflows page, window=_blank](https://defender.openzeppelin.com/v2/#/actions/workflows).
...
2. After the run is executed successfully, you can verify the response by checking the activity of the contract on [Etherscan, window=_blank](https://sepolia.etherscan.io/address/0xC64f7ace6127bc7B0bAb23bD1871aC81e6AEC074). It should look like this:
...
* [Workflow Documentation](:module/actions.adoc#workflows)
* [BoxV2, window=_blank](https://sepolia.etherscan.io/address/0xC64f7ace6127bc7B0bAb23bD1871aC81e6AEC074)
