...
In this tutorial, we will explore how to use the [Relayers](module/relayers) to send transactions. We will cover:
...
* For more information on using Relayer, refer to the [Relayers](/module/relayers) documentation.
* Explore the [Actions](:tutorial/actions) to automate your smart contract operational tasks with easy integration with the rest of Defender.
