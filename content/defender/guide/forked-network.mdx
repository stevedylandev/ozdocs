...
<Callout>
After deploying a contract, we recommend creating a Monitor and setting up Actions on Defender. Learn how to setup a Monitor [here](:tutorial/monitor), and use Actions with its tutorial [here](:tutorial/actions).
</Callout>
