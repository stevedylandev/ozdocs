...
Now, you can use [Defender Access Control](module/access-control) to grant or revoke roles of your `TimelockController` contract. Navigate to [Access Control, window=_blank](https://defender.openzeppelin.com/v2/#/access-control/contracts) and select your imported `TimelockController` contract.
