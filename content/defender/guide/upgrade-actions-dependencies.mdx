...
description: Upgrading Actions Dependencies
---
...
1. Check the Action [dependencies latest versions, window=_blank](https://docs.openzeppelin.com/defender/module/actions#environment) and search for any breaking changes in your Action code.
...
3. Test the Action code. A safe approach to do this:
  ...
  b. If your action sends relayer transactions using [defender-sdk, window=_blank](https://docs.openzeppelin.com/defender/sdk) (or any other Defender legacy package), validate that it works by connecting a testnet relayer with your action.
