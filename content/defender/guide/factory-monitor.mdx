...
* A Monitor watches for successful event emitted by the factory contract that creates a clone. If detected, it triggers an [Action](/defender/module/actions) and [passes along information](module/actions#monitor-invocations) about the transaction.
...
As with any action, the triggering of this Monitor will be recorded in the [Logs](logs).
