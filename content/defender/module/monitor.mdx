...
<Callout type='warn'>
At this time, Monitors are supported across all [networks](index#networks) except Fantom.
</Callout>
...
You can create **Notifications** attached to the Monitor alerts for getting notified about the on-chain events across many channels, see more about how to create and configure them in [this section](settings/notifications).
...
<Callout>
We provide a quickstart tutorial to monitor a smart contract using Defender. Check it out [here](tutorial/monitor)!
</Callout>
