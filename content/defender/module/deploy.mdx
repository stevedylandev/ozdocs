...
<Callout>
We provide a quickstart tutorial to deploy and upgrade a smart contract using Defender with Hardhat and Foundry. Check it out [here](tutorial/deploy)!
</Callout>

<Callout type='warn'>
Using `CREATE2` may affect `msg.sender` behavior; see documentation for details [here](tutorial/deploy#deploy-caveat)!
</Callout>
