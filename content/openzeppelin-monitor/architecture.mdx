...
For detailed information about RPC logic and network communication, see the [RPC section](rpc.mdx).
...
For configuration examples and best practices, see the [Configuration Guidelines](index.mdx#configuration_guidelines) section in the user documentation.
...
For detailed information about the project structure, source code organization, and development resources, see the [Project Structure](project-structure.mdx) guide.

For information about RPC logic and network communication, see the [RPC section](rpc.mdx).
