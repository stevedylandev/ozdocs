...
description: OpenZeppelin Monitor
---
...
To get started immediately, see [Quickstart](quickstart.mdx).
...
For more information about custom scripts, see [Custom Scripts Section](scripts.mdx).
...
The monitor implements a comprehensive error handling system with rich context and tracing capabilities. For detailed information about error handling, see [Error Handling Guide](error.mdx).
...
* Monitor performance depends on network congestion and RPC endpoint reliability.
  * View the [list of RPC calls](rpc.mdx#list_of_rpc_calls) made by the monitor.
...
* See performance considerations about custom scripts [here](scripts.mdx#performance_considerations).
