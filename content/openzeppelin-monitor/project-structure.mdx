...
For detailed information about running the monitor in containers, see the Docker deployment [section](index.mdx#docker_installation) in the user documentation.
