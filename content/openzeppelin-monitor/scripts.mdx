...
Integrate your custom filter script with the monitor by following the [configuration guidelines](index.mdx#trigger_conditions_custom_filters).
...
Integrate your custom notification script with the triggers by following the [configuration guidelines](index.mdx#custom_script_notifications).
