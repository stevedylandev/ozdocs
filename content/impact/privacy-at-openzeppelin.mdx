...
OpenZeppelin is advancing privacy as a core property of smart contract systems, not an afterthought. Our work focuses on enabling confidentiality, selective disclosure, and private coordination across on-chain applications.
...
Confidential contracts libraries and privacy relayer
</Card>
...
Cryptography contracts libraries
</Card>

<Card title="Midnight" href="https://github.com/OpenZeppelin/compact-contracts">
Privacy preserving contracts libraries, developer tooling, and starter decentralized applications
</Card>

<Card title="Miden">
Token standards (ERC-20 equivalent), private multisig, and shared state model
</Card>
</Cards>
<br/>
