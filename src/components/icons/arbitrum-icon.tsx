		...
		return (
			...
			>
				...
				<g fill="none">
					...
					<path
						fill="#213147"
						d="m7.559 18.685l.617-1.666l1.244 1.018l-1.163 1.046z"
					/>
					<path
						fill="#fff"
						d="M11.433 7.635H9.731a.3.3 0 0 0-.285.197l-3.649 9.852l1.761 1.001l4.018-10.849a.15.15 0 0 0-.143-.2m2.979-.001h-1.703a.3.3 0 0 0-.284.197l-4.167 11.25l1.761 1l4.535-12.246a.15.15 0 0 0-.142-.2"
					/>
				</g>
			</svg>
		);
